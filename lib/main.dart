...
import 'package:tora/view/main_drawer.dart';
import 'package:tora/view/routers.dart';
...
/// WARNING: trocar para usar um usuario real
    API.loginBasic(cfg.accountId, '1', '1').then((r) {
      if (kDebugMode) {
        print('login: $r');
      } 
      cfg.logado = true;
      cfg.apiKey = ODataInst().client.authorization;
    });

    return MaterialApp(
      title: 'AgroFlorest App',
      theme: ThemeData(
      ...
      home: const MyHomePage(title: 'AgroFlorest App'),
      routes: routes(),
